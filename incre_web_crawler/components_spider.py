...
class HardwareSpider:
    ...
    def __init__(self):
        self.driver = webdriver.PhantomJS(executable_path=r"C:\Python3\phantomjs-2.1.1-windows\bin\phantomjs.exe")
        ...
        for data in datas:
            ...
            for i in range(1, counts + 1):
                products = self.driver.find_elements_by_xpath(
                    f'//*[@id="product-cert-table"]/table/tbody/tr[{i}]/th[@headers="th-products"]')
                versions = self.driver.find_elements_by_xpath(
                    f'//*[@id="product-cert-table"]/table/tbody/tr[{i}]/td[@headers="th-person1 th-version"]')
                archs = self.driver.find_elements_by_xpath(
                    f'//*[@id="product-cert-table"]/table/tbody/tr[{i}]/td[@headers="th-person1 th-arch"]')
                labels = self.driver.find_elements_by_xpath(
                    f'//*[@id="product-cert-table"]/table/tbody/tr[{i}]/td[@headers="th-person1 th-level"]')
                product = ""
                version = ""
                arch = ""
                label = ""
...
def main():
    ...
    filename1 = r".\components.json"
    filename2 = r".\components_result.json"
